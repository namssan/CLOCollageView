...
- (void)scrollToPage2:(NSInteger)page duration:(NSTimeInterval)duration {
    [UIView animateWithDuration:duration animations:^{
        self.scrollView.contentOffset = CGPointMake(0.0, self.scrollView.frame.size.height * page);
    }];
}
- (void)resetGesture
{
